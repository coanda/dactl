internal class Dactl.Recorder.Main : GLib.Object {
    ...
    private static int main (string[] args) {
        ...
        Dactl.Recorder.Main main = null;
        Dactl.Recorder.DBusService service = null;
        ...
        try {
            ...
            main = new Dactl.Recorder.Main ();
            service = new Dactl.Recorder.DBusService (main);
            service.publish ();
        } catch (GLib.Error e) {
            error ("%s", e.message);
        }
