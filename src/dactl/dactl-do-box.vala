...
public class Dactl.DOBox : Gtk.Box {
    ...
    public DOBox (string chan_id, Dactl.ApplicationModel model) {
    ...
    private void create_widgets () {
        ...
        /* Layout widgets */
        var r1hbox = new Gtk.Box (Orientation.HORIZONTAL, 5);
        ...
        var vbox = new Gtk.Box (Orientation.VERTICAL, 10);
