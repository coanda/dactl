...
public class Dactl.UI.Application : Gtk.Application {
    ...
    protected override void activate () {
        ...
        WebKit.WebContext.get_default ().set_web_extensions_directory (Dactl.WEB_EXTENSION_DIR);
    ...
    public override int command_line (GLib.ApplicationCommandLine cmdline) {
        ...
        if (opt_cfgfile == null) {
            opt_cfgfile = Path.build_filename (Dactl.CONFDIR, "dactl.xml");
    ...
    private void about_activated_cb (SimpleAction action, Variant? parameter) {
        ...
        try {
         ...
         dialog.logo = logo;
         dialog.version = Dactl.PACKAGE_VERSION;
