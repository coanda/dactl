public class Dactl.Log.Factory : GLib.Object, Dactl.Factory {

    /* Singleton */
    private static Once<Dactl.Log.Factory> _instance;
     ...
     */
    public static unowned Dactl.Log.Factory get_default () {
        return _instance.once(() => { return new Dactl.Log.Factory (); });
    }
    ...
    private Dactl.Object? make_something (Xml.Node *node) {
        //return new Dactl.Log.Something.from_xml_node (node);
        return null;
    }
}
