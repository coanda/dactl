public class Dactl.DAQ.Factory : GLib.Object, Dactl.Factory {

    /* Singleton */
    private static Once<Dactl.DAQ.Factory> _instance;
     ...
     */
    public static unowned Dactl.DAQ.Factory get_default () {
        return _instance.once(() => { return new Dactl.DAQ.Factory (); });
    }
    ...
    private Dactl.Object? make_something (Xml.Node *node) {
        //return new Dactl.DAQ.Something.from_xml_node (node);
        return null;
    }
}
