...
namespace JSCore {
    ...
    [CCode (has_target = false, cname="JSObjectHasPropertyCallback")]
    public delegate bool         ObjectHasPropertyCallback        (Context ctx,
                                                                   JSCore.Object object,
                                                                   JSCore.String propertyName);

    [CCode (has_target = false, cname="JSObjectGetPropertyCallback")]
    public delegate JSCore.Value ObjectGetPropertyCallback        (Context ctx,
                                                                   JSCore.Object object,
                                                                   JSCore.String propertyName,
                                                                   out JSCore.Value exception);

    [CCode (has_target = false, cname="JSObjectSetPropertyCallback")]
    ...
    [CCode (has_target = false, cname="JSObjectDeletePropertyCallback")]
    public delegate bool          ObjectDeletePropertyCallback    (Context ctx,
                                                                   JSCore.Object object,
                                                                   JSCore.String propertyName,
                                                                   out JSCore.Value exception);

    [CCode (has_target = false, cname="JSObjectGetPropertyNamesCallback")]
    public delegate void          ObjectGetPropertyNamesCallback  (Context ctx,
                                                                   JSCore.Object object,
                                                                   PropertyNameAccumulator propertyNames);

    [CCode (has_target = false, cname="JSObjectCallAsFunctionCallback")]
    ...
    [CCode (has_target = false, cname="JSObjectCallAsConstructorCallback")]
    ...
    [CCode (has_target = false, cname="JSObjectHasInstanceCallback")]
    public delegate bool          ObjectHasInstanceCallback       (Context ctx,
                                                                   JSCore.Object constructor,
                                                                   JSCore.Value possibleInstance,
                                                                   out JSCore.Value exception);

    [CCode (has_target = false, cname="JSObjectConvertToTypeCallback")]
    ...
    public class Value {
        ...
        public bool is_object_of_class (Context ctx,
                                        Value js_value,
                                        Class js_class);
        ...
        public bool is_instance_of_constructor (Context ctx,
                                                Value js_value,
                                                Object constructor,
                                                Value *exception);
    ...
    public class Object: JSCore.Value {
        ...
        public Object.date (Context ctx,
                            size_t argument_count,
                            JSCore.Value[] arguments,
                            out JSCore.Value exception);

        [CCode (cname = "JSObjectMakeError")]
        public Object.error (Context ctx,
                             size_t argument_count,
                             JSCore.Value[] arguments,
                             out JSCore.Value exception);

        [CCode (cname = "JSObjectMakeRegExp")]
        public Object.regexp (Context ctx,
                              size_t argument_count,
                              JSCore.Value[] arguments,
                              out JSCore.Value exception);

        [CCode (cname = "JSObjectMakeFunction")]
        public Object.function (Context ctx,
                                JSCore.String name,
                                uint parameter_count,
                                JSCore.String[]? parameter_names,
                                JSCore.String body,
                                JSCore.String? source_url,
        ...
        public JSCore.Value get_property (Context ctx,
                                          JSCore.String propertyName,
                                          out JSCore.Value exception);

        [CCode (cname = "JSObjectSetProperty", instance_pos=1.1)]
        public void set_property (Context ctx,
                                  JSCore.String property_name,
                                  JSCore.Value _value,
                                  PropertyAttribute attributes,
                                  out JSCore.Value exception);

        [CCode (cname = "JSObjectDeleteProperty", instance_pos=1.1)]
        public bool delete_property (Context ctx,
                                     JSCore.String property_name,
                                     out JSCore.Value exception);

        [CCode (cname = "JSObjectGetPropertyAtIndex", instance_pos=1.1)]
        public JSCore.Value get_property_at_index (Context ctx,
                                                   uint property_index,
                                                   out JSCore.Value exception);

        [CCode (cname = "JSObjectSetPropertyAtIndex", instance_pos=1.1)]
        public void set_property_at_index (Context ctx,
                                           uint property_index,
                                           JSCore.Value _value,
                                           out JSCore.Value exception);
