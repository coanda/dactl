...
[CCode (cheader_filename = "msgpack.h", cprefix = "msgpack_")]
namespace MessagePack
{
	[CCode (cprefix = "MSGPACK_OBJECT_")]
	public enum Type
	{
		NIL,
		BOOLEAN,
	...
	[SimpleType]
	[CCode (cname = "msgpack_object_array", has_destroy_function = false)]
	public struct Array
	{
	...
	[SimpleType]
	[CCode (cname = "msgpack_map", has_destroy_function = false)]
	public struct Map
	{
		[CCode (cname = "ptr", array_length_cname = "size", array_length_type = "uint32_t")]
	...
	[SimpleType]
	[CCode (cname = "msgpack_object_str", has_destroy_function = false)]
	...
	[SimpleType]
	[CCode (cname = "msgpack_object_bin", has_destroy_function = false)]
	...
	[SimpleType]
	[CCode (cname = "msgpack_object_ext", has_destroy_function = false)]
	...
	[SimpleType]
	[CCode (cname = "msgpack_object", has_destroy_function = false)]
	public struct Object
	{
		MessagePack.Type type;

		// see 'msgpack_object_union'
		bool boolean;
		uint64 u64;
		int64 i64;
		double f64;
	...
	[CCode (cname = "msgpack_object_kv", has_destroy_function = false)]
	...
	[CCode (cname = "msgpack_packer_write", delegate_target_pos = "1")]
	public delegate int PackerWriteCallback ([CCode (array_length_type = "size_t")] uint8[] buf);

	[Compact]
	[CCode (cname = "msgpack_packer", cprefix = "msgpack_", free_function = "msgpack_packer_free")]
	public class Packer
	{
		[CCode (cname = "msgpack_packer_new", delegate_target_pos = "1")]
		public Packer (MessagePack.PackerWriteCallback callback);
